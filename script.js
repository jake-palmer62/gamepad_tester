...
function updateStatus() {
    if (gamepadIndex !== null) {
        ...
        // Update sticks
        updateStick('left-stick', gamepad.axes[0], gamepad.axes[1], gamepad.buttons[10]?.pressed);
        updateStick('right-stick', gamepad.axes[2], gamepad.axes[3], gamepad.buttons[11]?.pressed);
